# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2022-11-28 11:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('items', models.ManyToManyField(to='food_app.Item')),
                ('merchant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_merchant', to='food_app.CustomUser')),
            ],
        ),
        migrations.CreateModel(
            name='Store',
        ...
        migrations.AddField(
            model_name='item',
            name='store',
            field=models.ManyToManyField(through='food_app.StoreItem', to='food_app.Store'),
        ),
    ]
